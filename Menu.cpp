...
void resetcolours() {
	{
		...
		Settings.SetSetting(Tab_Other, Other_Cham_Weapon_Red, 0);
		Settings.SetSetting(Tab_Other, Other_Cham_Weapon_Green, 255);
		Settings.SetSetting(Tab_Other, Other_Cham_Weapon_Blue, 0);

		Settings.SetSetting(Tab_Other, Other_Misc_Sky_Red, 0);
		Settings.SetSetting(Tab_Other, Other_Misc_Sky_Green, 0);
		Settings.SetSetting(Tab_Other, Other_Misc_Sky_Blue, 0);

		Settings.SetSetting(Tab_Other, Other_Misc_CustomWalls_Red, 255);
		Settings.SetSetting(Tab_Other, Other_Misc_CustomWalls_Green, 255);
		Settings.SetSetting(Tab_Other, Other_Misc_CustomWalls_Blue, 255);

		Settings.SetSetting(Tab_Other, Other_Misc_Wire_Red, 255);
		Settings.SetSetting(Tab_Other, Other_Misc_Wire_Green, 255);
		Settings.SetSetting(Tab_Other, Other_Misc_Wire_Blue, 255);

		Settings.SetSetting(Tab_Other, Other_Misc_Hands_Red, 255);
		Settings.SetSetting(Tab_Other, Other_Misc_Hands_Green, 255);
		Settings.SetSetting(Tab_Other, Other_Misc_Hands_Blue, 255);
	...
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			if (Menu.GetCurret_SubTab() == Sub || Sub == -1) {
				...
				Interfaces.pSurface->DrawSetColor(15, 18, 22, 255);
				...
				{
					Interfaces.pSurface->DrawSetColor(3, 96, 235, 255);
					Interfaces.pSurface->DrawFilledRect(this->pos.x + 2, this->pos.y + 2, this->pos.x + 10, this->pos.y + 10);
				}
				Interfaces.pSurface->DrawSetColor(19, 22, 27, 255);
				Interfaces.pSurface->DrawOutlinedRect(this->pos.x, this->pos.y, this->pos.x + 12, this->pos.y + 12);
				Interfaces.pSurface->DrawT(this->pos.x + 15, this->pos.y - 1, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, this->Name);
			}
		}
	}
	...
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			if (Menu.GetCurret_SubTab() == SubTab || SubTab == -1) {
				...
				Interfaces.pSurface->DrawT(this->pos.x, this->pos.y - 12, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, "%s", this->Name, (float)Settings.GetMenuSetting(this->Tab, this->Setting));
				float Value1 = (float)Settings.GetMenuSetting(this->Tab, this->Setting);
				char vl[256];
				sprintf(vl, "%g", Value1);
				Interfaces.pSurface->DrawT(this->pos.x + Location, this->pos.y + 3.5, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, vl);
			}
		}
	}
...
public:
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			...
			Interfaces.pSurface->DrawSetColor(0, 180, 235, 255);
			...
			Interfaces.pSurface->DrawSetColor(150, 150, 150, 255);
			Interfaces.pSurface->DrawOutlinedRect(this->pos.x + Location - 3, this->pos.y, this->pos.x + Location + 3, this->pos.y + 20);

			Interfaces.pSurface->DrawT(this->pos.x, this->pos.y - 12, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, "%s: %.1f", this->Name, (float)Settings.GetMenuSetting(this->Tab, this->Setting));
		}
	}
	...
	void Draw()
	{
		if (Tab == Menu.GetCurret_Tab())
		{
			if (Menu.GetCurret_SubTab() == Sub || Sub == -1) {
				...
				Interfaces.pSurface->DrawT(this->pos.x, this->pos.y - 13, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, this->Name);

				if (this->Dropping)
				{
					for (int i = 1; i < this->Amount; i++)
					{
						Interfaces.pSurface->DrawSetColor(15, 18, 22, 255); //dark top color
						...
						Interfaces.pSurface->DrawT(this->pos.x + 8, this->pos.y + 4 + (20 * i), CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, this->Parts[i]);
					}
				}
				else
				{
					...
					if (value >= this->Amount)
						value = 0;
					Interfaces.pSurface->DrawT(this->pos.x + 8, this->pos.y + 4, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, this->Parts[value]);

					static int Texture = Interfaces.pSurface->CreateNewTextureID(true); //need to make a texture with procedural true
					unsigned char buffer[4] = { 19, 22, 27, 255 };//{ color.r(), color.g(), color.b(), color.a() };

					Interfaces.pSurface->DrawSetTextureRGBA(Texture, buffer, 1, 1); //Texture, char array of texture, width, height
					Interfaces.pSurface->DrawSetColor(15, 15, 16, 255); // keep this full color and opacity use the RGBA @top to set values.
	...
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			if (Menu.GetCurret_SubTab() == Sub || Sub == -1) {
				...
				Interfaces.pSurface->DrawT(this->pos.x, this->pos.y - 12, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, "%s", this->Name);
				Interfaces.pSurface->DrawSetColor(19, 22, 27, 255);
				...
				{
					Interfaces.pSurface->DrawT(this->pos.x + 40, this->pos.y + 3, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, true, "<PRESS>");
				}
				else
				{
					if (Settings.GetMenuSetting(this->Tab, this->Setting) == -1)
						Interfaces.pSurface->DrawT(this->pos.x + 40, this->pos.y + 3, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, true, "<UNSET>");
					else
					{
						char* NameOfKey = KeyStrings[(int)Settings.GetMenuSetting(this->Tab, this->Setting)];
						Interfaces.pSurface->DrawT(this->pos.x + 40, this->pos.y + 3, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, true, NameOfKey);
					}
				}
			}
		}
...
public:
	void Update()
	{
		pos.x = Menu.pos.x - 143;
		pos.y = Menu.pos.y + ((400 / Tab_Count) * Tab);
	...
	void Draw()
	{
		Interfaces.pSurface->DrawSetColor(19, 22, 27, 200);
		Interfaces.pSurface->DrawFilledRect(pos.x, pos.y, pos.x + (1000 / Tab_Count), pos.y + 60);
		if (Menu.GetCurret_Tab() == Tab)
		{
			Interfaces.pSurface->DrawSetColor(15, 18, 22, 200);
			Interfaces.pSurface->DrawFilledRect(pos.x, pos.y, pos.x + (1000 / Tab_Count), pos.y + 60);
	...
	void Draw()
	{
		if (Tab == Menu.GetCurret_Tab())
		{
			if (SubTab == Menu.GetCurret_SubTab() || SubTab == -1) {
				...
				/* check center */
				Interfaces.pSurface->GetTextSize(Hacks.Font_Vermin_Vibes, wBuffer, Width, Height);
				...
				Interfaces.pSurface->DrawT(pos.x + 10, pos.y - 7, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, Name);
...
public:
	...
	void Draw()
	{
		if (Menu.GetCurret_Tab() == Tab)
		{
			...
			Interfaces.pSurface->DrawT(this->pos.x + 50, this->pos.y + 3, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, true, Name);
	...
	for (int i = 0; i < 10; i++) {
		...
		if (number > amount) {
			...
			if (number == selected[setting]) {
				Interfaces.pSurface->DrawT(startx + 3, starty + i * 20 + 3, CColor(20, 200, 255, 255), Hacks.Font_Vermin_Vibes, false, arr[number]);
				realselected[setting] = realvals[number];
			}
			else
				Interfaces.pSurface->DrawT(startx + 3, starty + i * 20 + 3, CColor(255, 255, 255, 255), Hacks.Font_Vermin_Vibes, false, arr[number]);
...
void SetupMenu()
{
	...
	AddNewSubMenuBox("Global", 530, 80, 120, 280, Tab_LegitBot, Sub_Aimbot);
	{
		...
		AddNewSubButton(Tab_LegitBot, Legit_AutoPistol, true, 540, 210, "AutoPistol", Sub_Aimbot);
	...
	*/
	...
	AddNewButton(Tab_Ragebot, Ragebot_NewAimbot, false, 142, 55, "New Aimbot");
	AddNewMenuBox("Aim", 20, 80, 130, 300, Tab_Ragebot);
	{
		...
		AddNewKeyButton(35, 220, Tab_Ragebot, Rabebot_On_Key_Button, "Key");
		AddNewButton(Tab_Ragebot, Ragebot_AutoDuck, false, 25, 250, "Auto Duck (NO USE)");
		AddNewButton(Tab_Ragebot, Ragebot_Autoscope, false, 25, 270, "Auto Scope");
		AddNewSlider(25, 300, 0, 110, 0, "Minimum Damage", Tab_Ragebot, Ragebot_MinDam);
		AddNewSlider(25, 330, 0, 39.9, 0, "Aim Step", Tab_Ragebot, Ragebot_Speed_Limit_Amount);
		AddNewSlider(25, 360, 0, 100, 0, "Hit Chance", Tab_Ragebot, Ragebot_Hitchance_Amount);
	}

	AddNewMenuBox("AntiAim", 170, 80, 130, 300, Tab_Ragebot);
	{
		AddNewButton(Tab_Ragebot, AntiAim_Enable, false, 175, 90, "Enable");
		std::vector<char*> Antiaim_X = { "", "","Emotion", "Down", "Up", "FakeStatic", "FakeDown", "Float(BB)", "BackFlip", "FakeEmotion", "Zero", "Test2", "Test3", "FakeJitter", "CustomAA", "StaticJitter" };
		AddNewDropbox(175, 120, Tab_Ragebot, AntiAim_X, "Antiaim Pitch", 16, Antiaim_X);
		std::vector<char*> Antiaim_Y = { "", "","Backwards", "Jitter", "Left", "Right", "Forward", "pAA(Fake)", "StaticJitter", "SidewaysJitter", "TJitter", "HalfRight", "HalfLeft", "Backwards[AT]", "AngelInverse", "Float(BB)", "CustomReal", "CustomFake", "BackJitter" };
		AddNewDropbox(175, 160, Tab_Ragebot, AntiAim_Y, "Fake Yaw", 19, Antiaim_Y);
		AddNewDropbox(175, 200, Tab_Ragebot, AntiAim_FY, "Real Yaw", 19, Antiaim_Y);
	...
	AddNewMenuBox("Custom AntiAim", 630, 80, 130, 300, Tab_Ragebot);
	{
		AddNewButton(Tab_Ragebot, Ragebot_MinusRealx, false, 635, 90, "Minus Real X");
		AddNewSlider(635, 120, 0, 89, 0, "Custom Real X", Tab_Ragebot, Ragebot_Realx);

		AddNewButton(Tab_Ragebot, Ragebot_MinusFakex, false, 635, 140, "Minus Fake X");
		AddNewSlider(635, 170, 0, 89, 0, "Custom Fake X", Tab_Ragebot, Ragebot_Fakex);



		AddNewButton(Tab_Ragebot, Ragebot_MinusRealy, false, 635, 210, "Minus Real Y");
		AddNewSlider(635, 240, 0, 180, 0, "Custom Real Y", Tab_Ragebot, Ragebot_Realy);

		AddNewButton(Tab_Ragebot, Ragebot_MinusFakey, false, 635, 260, "Minus Fake Y");
		AddNewSlider(635, 290, 0, 180, 0, "Custom Fake Y", Tab_Ragebot, Ragebot_Fakey);
	...
	AddNewSubTab("OTHER", Tab_Misc, Sub_Other);
	{
		AddNewSubMenuBox("Movement", 20, 80, 130, 300, Tab_Misc, Sub_Misc);
		{
			...
			AddNewSubKeyButton(30, 180, Tab_Misc, Misc_CircleStrafe_Key, "Circle Strafe", Sub_Misc);
			AddNewSubButton(Tab_Misc, Misc_Airstuck_Enabled, false, 25, 210, "Airstuck", Sub_Misc);
			AddNewSubKeyButton(30, 240, Tab_Misc, Misc_Airstuck_Key, "Airstuck", Sub_Misc);

			std::vector<char*> fakelag = { "", "Off", "Max", "Adaptive", "In Air" };
			AddNewSubDropbox(30, 280, Tab_Misc, Misc_Fakelagtype, "Fake Lag Type", 5, fakelag, Sub_Misc);
			AddNewSubButton(Tab_Misc, Misc_Fakelag_Shoot, true, 25, 310, "While Shooting", Sub_Misc);
			AddNewSubSlider(25, 340, 0, 13, 0, "FLag Ammount", Tab_Misc, Misc_FakelagAmmount, Sub_Misc);
		}
		AddNewSubMenuBox("Vanity", 170, 80, 130, 300, Tab_Misc, Sub_Misc);
		{
			...
			std::vector<char*> Spams1 = { "Off", "JesusCry", "SKEET", "NONAME", "AIMWARE", "ABitSmarter", "PU SUCKS", "Jesus$Cry", "SK4M$WARE" ,"OYAA", };
			AddNewSubDropbox(175, 110, Tab_Misc, Misc_NameStealer_Index, "", 9, Spams1, Sub_Misc);
			//
			AddNewSubButton(Tab_Misc, Misc_Clan_Active, false, 175, 150, "Clan Tag", Sub_Misc);
			std::vector<char*> Spams2 = { "Off", "splashgang", "Advert /Hide/", "Advert /Action/", "Advert /Meme Style/", "Advert /Flash/", "Jesus$Cry" };
			AddNewSubDropbox(175, 170, Tab_Misc, Misc_Clan_Index, "", 7, Spams2, Sub_Misc);
			//
			AddNewSubButton(Tab_Misc, Misc_Spam_Active, false, 175, 210, "Chat Spam", Sub_Misc);
			std::vector<char*> Spams3 = { "Off", "Advert", "Random Shit", "Enemy Location", "Teamm8 Location", "Advert /Group&Site/", };
			AddNewSubDropbox(175, 230, Tab_Misc, Misc_Spam_Index, "", 6, Spams3, Sub_Misc);
			AddNewSubSlider(175, 270, 0, 50, 20, "Chat Spam Speed", Tab_Misc, Misc_Spam_Speed, Sub_Misc);
		}
		...
		//}
			...
			AddNewSubMenuBox("Functions", 320, 80, 130, 140, Tab_Misc, Sub_Misc);
			{
				...
				AddNewSubButton(Tab_Misc, Misc_Watermark, true, 325, 130, "Fade Watermark", Sub_Misc);
			...
			AddNewSubMenuBox("Teleport", 320, 240, 130, 140, Tab_Misc, Sub_Misc);
			{
				...
				AddNewSubKeyButton(330, 280, Tab_Misc, Misc_Teliport, "Teleport Key", Sub_Misc);
				AddNewSubDropbox(325, 320, Tab_Misc, Misc_Teliport_Type, "Teleport Method", 4, tptypes, Sub_Misc);
			}

		}
		{
			// OTHER
			AddNewSubMenuBox("FUN&OTHER", 20, 80, 600, 300, Tab_Misc, Sub_Other);
			{
				AddNewSubButton(Tab_Misc, Misc_AsusWalls, false, 25, 90, "Custom Walls", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_CustomSky, false, 25, 110, "Custom Sky", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_PostProcessing, false, 25, 130, "Disable Post Processing", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_Bypass, false, 25, 150, "Thirdperson", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_EnableFOV, false, 25, 170, "Enable FOV", Sub_Other);
				AddNewSubSlider(25, 200, 0, 180, 68, "Model FOV Value", Tab_Misc, Misc_FovValue, Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_AsusWalls1, false, 25, 230, "Asus Walls", Sub_Other);
				AddNewSubSlider(25, 260, 0, 1, 1, "Asus Walls Value", Tab_Misc, Misc_AsusWallsValue, Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_WireframeWalls, false, 25, 290, "Wireframe Walls", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_NoFlash, false, 25, 310, "No Flash", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_Weapon, false, 175, 90, "Custom Weapon Chams", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_Build, true, 175, 110, "Show Build Date", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_Time, true, 175, 130, "Show Build Time", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_MethyHands, false, 175, 150, "Remove hands", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_ViewEnable, false, 175, 170, "Custom Viewmodel", Sub_Other);
				AddNewSubSlider(175, 200, 0, 50, 3, "X Axis", Tab_Misc, Misc_ViewX, Sub_Other);
				AddNewSubSlider(175, 230, 0, 50, 3, "Y Axis", Tab_Misc, Misc_ViewY, Sub_Other);
				AddNewSubSlider(175, 260, 0, 50, 3, "Z Axis", Tab_Misc, Misc_ViewZ, Sub_Other);
				std::vector<char*> Cross1 = { "None", "None", "Small m3m3", "Circle", "m3m3 in da circles", "Show FOV", "Cross" };
				AddNewSubDropbox(175, 300, Tab_Misc, Misc_Cross_Index, "Crosshair Type", 7, Cross1, Sub_Other);
				AddNewSubSlider(350, 300, 0, 50, 5, "Cross Size", Tab_Misc, Misc_CrossSize, Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_WireHands, false, 175, 330, "Wireframe Hands", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_ChamHands, false, 175, 350, "Cham Hands", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_HJitter, false, 350, 90, "Hands Jitter", Sub_Other);
				AddNewSubButton(Tab_Misc, Misc_RevRanks, false, 475, 90, "Show MM Ranks", Sub_Other);
		...
		AddNewMenuBox("ESP", 20, 80, 130, 300, Tab_Visuals);
		{
			...
			AddNewButton(Tab_Visuals, Vis_Weapon, false, 25, 190, "Weapons");
			AddNewButton(Tab_Visuals, Vis_Background, false, 25, 210, "Health");
			AddNewButton(Tab_Visuals, Vis_Health, false, 25, 230, "Health&ArmorBar");
			AddNewButton(Tab_Visuals, Vis_AimLines, false, 25, 250, "Aim Lines");
			AddNewButton(Tab_Visuals, Vis_Skel, false, 25, 270, "Skeleton ESP");
			AddNewButton(Tab_Visuals, Vis_Ammo, false, 25, 290, "Ammo*");
			AddNewButton(Tab_Visuals, Vis_Bomb, false, 25, 330, "Bomb*");
			AddNewButton(Tab_Visuals, Vis_GrenadePred, false, 25, 310, "Grenade Prediction*");


		}
		AddNewMenuBox("Chams", 170, 80, 130, 300, Tab_Visuals);
		{
			...
			AddNewButton(Tab_Visuals, Vis_Word, false, 175, 290, "World Adjustments");
		}
		...
		{//Colours 1
			...
			AddNewSubMenuBox("Background", 135, 70, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(145, 90, 0, 255, 15, "Red", Tab_Other, Other_BackgroundRed, Sub_Colour1);
				AddNewSubSlider(145, 120, 0, 255, 15, "Green", Tab_Other, Other_BackgroundGreen, Sub_Colour1);
				AddNewSubSlider(145, 150, 0, 255, 15, "Blue", Tab_Other, Other_BackgroundBlue, Sub_Colour1);
				AddNewSubSlider(145, 180, 0, 255, 255, "Alpha", Tab_Other, Other_BackgroundAlpha, Sub_Colour1);
			}
			AddNewSubMenuBox("Outline", 135, 220, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(145, 240, 0, 255, 50, "Red", Tab_Other, Other_OutlineRed, Sub_Colour1);
				AddNewSubSlider(145, 270, 0, 255, 50, "Green", Tab_Other, Other_OutlineGreen, Sub_Colour1);
				AddNewSubSlider(145, 300, 0, 255, 50, "Blue", Tab_Other, Other_OutlineBlue, Sub_Colour1);
				AddNewSubSlider(145, 330, 0, 255, 255, "Alpha", Tab_Other, Other_OutlineAlpha, Sub_Colour1);
			}
			AddNewSubMenuBox("ESP T Visible", 265, 70, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(275, 90, 0, 255, 247, "Red", Tab_Other, Other_Esp_T_Visible_Red, Sub_Colour1);
				AddNewSubSlider(275, 120, 0, 255, 180, "Green", Tab_Other, Other_Esp_T_Visible_Green, Sub_Colour1);
				AddNewSubSlider(275, 150, 0, 255, 20, "Blue", Tab_Other, Other_Esp_T_Visible_Blue, Sub_Colour1);
				AddNewSubSlider(275, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Esp_T_Visible_Alpha, Sub_Colour1);
			}
			AddNewSubMenuBox("ESP T Invisible", 265, 220, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(275, 240, 0, 255, 240, "Red", Tab_Other, Other_Esp_T_inVisible_Red, Sub_Colour1);
				AddNewSubSlider(275, 270, 0, 255, 30, "Green", Tab_Other, Other_Esp_T_inVisible_Green, Sub_Colour1);
				AddNewSubSlider(275, 300, 0, 255, 35, "Blue", Tab_Other, Other_Esp_T_inVisible_Blue, Sub_Colour1);
				AddNewSubSlider(275, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Esp_T_inVisible_Alpha, Sub_Colour1);
			}
			AddNewSubButton(Tab_Other, Other_Esp_Enemy_Rainbow, false, 285, 370, "Rainbow", Sub_Colour1);

			AddNewSubMenuBox("ESP CT Visible", 395, 70, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(405, 90, 0, 255, 32, "Red", Tab_Other, Other_Esp_CT_Visible_Red, Sub_Colour1);
				AddNewSubSlider(405, 120, 0, 255, 180, "Green", Tab_Other, Other_Esp_CT_Visible_Green, Sub_Colour1);
				AddNewSubSlider(405, 150, 0, 255, 57, "Blue", Tab_Other, Other_Esp_CT_Visible_Blue, Sub_Colour1);
				AddNewSubSlider(405, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Esp_CT_Visible_Alpha, Sub_Colour1);
			}
			AddNewSubMenuBox("ESP CT Invisible", 395, 220, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(405, 240, 0, 255, 63, "Red", Tab_Other, Other_Esp_CT_inVisible_Red, Sub_Colour1);
				AddNewSubSlider(405, 270, 0, 255, 72, "Green", Tab_Other, Other_Esp_CT_inVisible_Green, Sub_Colour1);
				AddNewSubSlider(405, 300, 0, 255, 205, "Blue", Tab_Other, Other_Esp_CT_inVisible_Blue, Sub_Colour1);
				AddNewSubSlider(405, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Esp_CT_inVisible_Alpha, Sub_Colour1);
			}
			AddNewSubButton(Tab_Other, Other_Esp_Team_Rainbow, false, 420, 370, "Rainbow", Sub_Colour1);

			AddNewSubMenuBox("Glow Visible", 525, 70, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(535, 90, 0, 255, 0, "Red", Tab_Other, Other_Glow_Visible_Red, Sub_Colour1);
				AddNewSubSlider(535, 120, 0, 255, 255, "Green", Tab_Other, Other_Glow_Visible_Green, Sub_Colour1);
				AddNewSubSlider(535, 150, 0, 255, 0, "Blue", Tab_Other, Other_Glow_Visible_Blue, Sub_Colour1);
				AddNewSubSlider(535, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Glow_Visible_Alpha, Sub_Colour1);
			}
			AddNewSubMenuBox("Glow Invisible", 525, 220, 130, 140, Tab_Other, Sub_Colour1);
			{
				AddNewSubSlider(535, 240, 0, 255, 255, "Red", Tab_Other, Other_Glow_inVisible_Red, Sub_Colour1);
				AddNewSubSlider(535, 270, 0, 255, 0, "Green", Tab_Other, Other_Glow_inVisible_Green, Sub_Colour1);
				AddNewSubSlider(535, 300, 0, 255, 0, "Blue", Tab_Other, Other_Glow_inVisible_Blue, Sub_Colour1);
				AddNewSubSlider(535, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Glow_inVisible_Alpha, Sub_Colour1);
			}
		...
		{//Colours 2
			...
			AddNewSubMenuBox("Cham Chicken Visible", 135, 70, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(145, 90, 0, 255, 0, "Red", Tab_Other, Other_Cham_Chicken_Visible_Red, Sub_Colour2);
				AddNewSubSlider(145, 120, 0, 255, 0, "Green", Tab_Other, Other_Cham_Chicken_Visible_Green, Sub_Colour2);
				AddNewSubSlider(145, 150, 0, 255, 255, "Blue", Tab_Other, Other_Cham_Chicken_Visible_Blue, Sub_Colour2);
				AddNewSubSlider(145, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Chicken_Visible_Alpha, Sub_Colour2);
			}
			AddNewSubMenuBox("Cham Chicken inVisible", 135, 220, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(145, 240, 0, 255, 200, "Red", Tab_Other, Other_Cham_Chicken_inVisible_Red, Sub_Colour2);
				AddNewSubSlider(145, 270, 0, 255, 200, "Green", Tab_Other, Other_Cham_Chicken_inVisible_Green, Sub_Colour2);
				AddNewSubSlider(145, 300, 0, 255, 200, "Blue", Tab_Other, Other_Cham_Chicken_inVisible_Blue, Sub_Colour2);
				AddNewSubSlider(145, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Chicken_inVisible_Alpha, Sub_Colour2);
			}
			AddNewSubButton(Tab_Other, Other_Cham_Chicken_Rainbow, false, 150, 370, "Rainbow", Sub_Colour2);

			AddNewSubMenuBox("Cham Enemy Visible", 265, 70, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(275, 90, 0, 255, 0, "Red", Tab_Other, Other_Cham_Enemy_Visible_Red, Sub_Colour2);
				AddNewSubSlider(275, 120, 0, 255, 255, "Green", Tab_Other, Other_Cham_Enemy_Visible_Green, Sub_Colour2);
				AddNewSubSlider(275, 150, 0, 255, 255, "Blue", Tab_Other, Other_Cham_Enemy_Visible_Blue, Sub_Colour2);
				AddNewSubSlider(275, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Enemy_Visible_Alpha, Sub_Colour2);
			}
			AddNewSubMenuBox("Cham Enemy Invisible", 265, 220, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(275, 240, 0, 255, 255, "Red", Tab_Other, Other_Cham_Enemy_inVisible_Red, Sub_Colour2);
				AddNewSubSlider(275, 270, 0, 255, 255, "Green", Tab_Other, Other_Cham_Enemy_inVisible_Green, Sub_Colour2);
				AddNewSubSlider(275, 300, 0, 255, 0, "Blue", Tab_Other, Other_Cham_Enemy_inVisible_Blue, Sub_Colour2);
				AddNewSubSlider(275, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Enemy_inVisible_Alpha, Sub_Colour2);
			}
			AddNewSubButton(Tab_Other, Other_Cham_Enemy_Rainbow, false, 285, 370, "Rainbow", Sub_Colour2);

			AddNewSubMenuBox("Cham Team Visible", 395, 70, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(405, 90, 0, 255, 255, "Red", Tab_Other, Other_Cham_Team_Visible_Red, Sub_Colour2);
				AddNewSubSlider(405, 120, 0, 255, 138, "Green", Tab_Other, Other_Cham_Team_Visible_Green, Sub_Colour2);
				AddNewSubSlider(405, 150, 0, 255, 255, "Blue", Tab_Other, Other_Cham_Team_Visible_Blue, Sub_Colour2);
				AddNewSubSlider(405, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Team_Visible_Alpha, Sub_Colour2);
			}
			AddNewSubMenuBox("Custom Sky", 525, 220, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(535, 240, 0, 255, 0, "Red", Tab_Other, Other_Misc_Sky_Red, Sub_Colour2);
				AddNewSubSlider(535, 270, 0, 255, 0, "Green", Tab_Other, Other_Misc_Sky_Green, Sub_Colour2);
				AddNewSubSlider(535, 300, 0, 255, 0, "Blue", Tab_Other, Other_Misc_Sky_Blue, Sub_Colour2);
			}

			AddNewSubMenuBox("Custom Walls", 525, 70, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(535, 90, 0, 255, 255, "Red", Tab_Other, Other_Misc_CustomWalls_Red, Sub_Colour2);
				AddNewSubSlider(535, 120, 0, 255, 255, "Green", Tab_Other, Other_Misc_CustomWalls_Green, Sub_Colour2);
				AddNewSubSlider(535, 150, 0, 255, 255, "Blue", Tab_Other, Other_Misc_CustomWalls_Blue, Sub_Colour2);
				AddNewSubSlider(535, 180, 0, 255, 255, "Alpha", Tab_Other, Other_Misc_CustomWalls_Alpha, Sub_Colour2);
			}


			AddNewSubMenuBox("Wireframe Hands", 655, 220, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(665, 240, 0, 255, 255, "Red", Tab_Other, Other_Misc_Wire_Red, Sub_Colour2);
				AddNewSubSlider(665, 270, 0, 255, 255, "Green", Tab_Other, Other_Misc_Wire_Green, Sub_Colour2);
				AddNewSubSlider(665, 300, 0, 255, 255, "Blue", Tab_Other, Other_Misc_Wire_Blue, Sub_Colour2);
				AddNewSubSlider(665, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Misc_Wire_Alpha, Sub_Colour2);
			}
			AddNewSubMenuBox("Cham Team Invisible", 395, 220, 130, 140, Tab_Other, Sub_Colour2);
			{
				AddNewSubSlider(405, 240, 0, 255, 178, "Red", Tab_Other, Other_Cham_Team_inVisible_Red, Sub_Colour2);
				AddNewSubSlider(405, 270, 0, 255, 0, "Green", Tab_Other, Other_Cham_Team_inVisible_Green, Sub_Colour2);
				AddNewSubSlider(405, 300, 0, 255, 55, "Blue", Tab_Other, Other_Cham_Team_inVisible_Blue, Sub_Colour2);
				AddNewSubSlider(405, 330, 0, 255, 255, "Alpha", Tab_Other, Other_Cham_Team_inVisible_Alpha, Sub_Colour2);
			}
		...
		{
			std::vector<char*> configtype = { "Default", "Legit","HvH", "Nospread HVH", "Casual", "Custom1", "Custom2" };
